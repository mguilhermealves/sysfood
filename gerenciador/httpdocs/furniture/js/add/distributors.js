data_distributors_json.template = '<div class="row_js#CLASS#"#ADD#>';
data_distributors_json.template +=
	'  <div class="cell" style="overflow:hidden;"#ADD_NAME#>#NAME#</div>';
data_distributors_json.template +=
	'  <div class="cell" style="overflow:hidden;"#ADD_MTRIX#>#MTRIX#</div>';
data_distributors_json.template +=
	'  <div class="cell" style="overflow:hidden;"#ADD_STATUS#>#STATUS#</div>';
data_distributors_json.template +=
	'  <div class="cell cell_last" style="min-width: 240px !important;display: flex;justify-content: center;align-items: center;"#ADD_ACAO#>#ACAO#</div>';
data_distributors_json.template += "</div>";

data_distributors_json.footer = '<div class="row_js table_data_footer">';
data_distributors_json.footer +=
	' <div class="cell cell_last table_data_footer">';
data_distributors_json.footer += "     Linha por Página ";
data_distributors_json.footer += '     <select id="per_page">';
data_distributors_json.footer +=
	'         <option value="20" selected>20</option>';
data_distributors_json.footer += '         <option value="50">50</option>';
data_distributors_json.footer += '         <option value="100">100</option>';
data_distributors_json.footer += "     </select>";
data_distributors_json.footer += " </div>";
data_distributors_json.footer +=
...
$.ajax({
	type: "GET",
	url: data_distributors_json.url,
	data: data_distributors_json.data,
	success: function (data) {
		console.log(data);
		$.each(data.total, function (i, o) {
			$("#" + i + "SpanUser").html(o);
		});
		data_distributors_json.out_data = data;
		fn_common.render_data(
			data_distributors_json.template + '<div class="row_data"></div>',
			{
				"#CLASS#": " row_js_header",
				"#ADD#": "",
				"#NAME#":
				...
				"#MTRIX#":
					'<button style="width: 100%; background-color: #ffffff; color: #707070; text-align: left; font-weight: bold; padding: 0px;" id="btn_ordenation_perfil" type="button">Cod. Mtrix <i class="fa fa-border-none"></i></button>',
				"#STATUS#":
			...
			fn_common.render_data(
				data_distributors_json.template,
				{
					...
					"#ACAO#":
						...
						o.idx +
						'" class="btn button info round"><i class="fontello-edit"></i> Editar</a><a href="/distribuidora/' +
						o.idx +
...
var fn_common = {
	...
	paginate: function (sr) {
		...
		if (paginate < data_distributors_json.out_data.total.total) {
			last_paginate =
				data_distributors_json.out_data.total.total % per_page == 0
					? data_distributors_json.out_data.total.total / per_page
					: Math.floor(data_distributors_json.out_data.total.total / per_page) +
					  1;
		...
		paginate_text += " de " + data_distributors_json.out_data.total.total;
