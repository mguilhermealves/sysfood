                    ...
                    <div style="display: flex;justify-content: space-evenly; padding-top:15px">
                        <div class="large-12 columns bxs_user">
                            ...
                            <div class="large-6 columns">
                                <label>
                                    N° de Lugares:
                                    <input type="number" name="qtd_chairs" min="0" max="20" value="<?php print(isset($data["qtd_chairs"]) ? $data["qtd_chairs"] : "") ?>">
                                </label>
                            </div>
                            ...
                            <div class="large-6 columns">
                                <label>
                                    ...
                                    <select id="position" name="position">
                                        <option value="" <?php print(!isset($data["position"]) || $data["position"] == "" ? " selected" : "") ?>></option>
                                        <?php
                                        foreach ($GLOBALS["position_tables"] as $k => $v) {
                                            printf('<option value="%s"%s>%s</option>' . "\n", $k, isset($data["position"]) && $data["position"] == $k ? ' selected="selected"' : '', $v);
                                        }
                                        ?>
                                    </select>
                                </label>
