    ...
    <div class="large-12 columns">
        <div class="box solaris-header">
            <div class="box-header bg-transparent">
                <h3 class="box-title">
                    <span>Listagem de Depoimentos</span>
                </h3>
            </div>
        </div>
        <div class="box solaris-head">
            <div class="box-body" style="padding-left: 0px;padding-right: 0px;">
                <form  class="row_js" style="flex-wrap: wrap; justify-content: flex-start; padding-top: 2rem;"  id="frm_filter" method="GET" action="<?php print( $GLOBALS["treatments_url"] ) ?>" style="display: flex;flex-direction: row;justify-content: space-around;align-items: flex-end;">
                    ...
                    <div class="large-4 columns">
                        <label>
                            Unidade
                            <select name="filter_type" name="filter_type">
                                <option value="" <?php print( !isset( $info["get"]["filter_type"] ) || $info["get"]["filter_type"] == "" ? " selected" : "" ) ?>></option>
                                <?php 
                                foreach( typestreatments_controller::data4select("idx" , array( " active = 'yes' " ) ) as $k => $v ){
                        ...
                        <div style="position: relative; top: 20px; left: 20px;">
                            ...
                            <a class="btn button bg-gray round" title="Incluir" href="<?php print( $form["pattern"]["new"] ) ?>"><i class="fontello-plus"></i> Adicionar Depoimento</a>
                        </div>
                    </div>
                </form>
