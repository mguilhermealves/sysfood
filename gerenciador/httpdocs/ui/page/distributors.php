    ...
    <div class="large-12 columns">
        <div class="box solaris-header">
            <div class="box-header bg-transparent">
                <h3 class="box-title">
                    <span>Listagem de Distribuidoras</span>
                </h3>
            </div>
        </div>
            ...
            <div class="box-body" style="padding-left:0px;padding-right:0px;">
                ...
                <form class="row_js" style="flex-wrap: wrap; justify-content: flex-start; padding-top: 2rem;" id="frm_filter" method="GET" action="<?php print($GLOBALS["distributors_url"]) ?>" style="display: flex;flex-direction: row;justify-content: space-around;align-items: flex-end;">
                    ...
                    <div style="position: relative; top: 20px; left: 20px;">
                        ...
                        <a class="btn button bg-gray round" title="Incluir" href="<?php print($form["pattern"]["distributor"]) ?>"><i class="fontello-plus"></i> Nova Distribuidora</a>
                    </div>
            </div>
            </form>
