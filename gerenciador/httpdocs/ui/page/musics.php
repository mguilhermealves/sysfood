    ...
    <div class="large-12 columns">
        ...
        <div class="box solaris-head">
            ...
            <?php
                ...
                <form  class="row_js" style="flex-wrap: wrap; justify-content: flex-start; padding-top: 2rem;"  id="frm_filter" method="GET" action="<?php print( $GLOBALS["musics_url"] ) ?>" style="display: flex;flex-direction: row;justify-content: space-around;align-items: flex-end;">
                    ...
                    <div class="large-2 columns"> <label>
                            Nome da Banda
                            <input type="text"  name="filter_banda" value="<?php print( isset( $info["get"]["filter_banda"] ) ? $info["get"]["filter_banda"] : "" ) ?>">
                        </label>
                    </div>                    
                    <div class="large-2 columns"> <label>
                            Nome da Musica
                            <input type="text"  name="filter_music" value="<?php print( isset( $info["get"]["filter_music"] ) ? $info["get"]["filter_music"] : "" ) ?>">
                        </label>
                    </div>                    
                    <!-- <div class="large-2 columns">
                        ...
                        <div style="position: relative; top: 20px; left: 20px;">
                            ...
                            <!-- <a class="btn button bg-gray round" title="Incluir" href="<?php print( $form["pattern"]["music"] ) ?>"><i class="fontello-plus"></i> Adicionar Selfie</a>
                        </div> -->
