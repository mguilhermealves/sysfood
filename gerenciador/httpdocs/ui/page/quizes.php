    ...
    <div class="large-12 columns" >
        <div class="box solaris-header">
            <div class="box-header bg-transparent">
                <h3 class="box-title">
                    <span>Listagem de Quiz</span>
                </h3>
            </div>
        </div>
        <div class="box solaris-head">
            <div class="box-body" style="padding-left:0px;padding-right:0px;">
                <form class="row_js" style="flex-wrap: wrap; justify-content: flex-start; padding-top: 2rem;" id="frm_filter" method="GET" action="<?php print( $GLOBALS["quizes_url"] ) ?>">
                    ...
                    <div class="large-8 columns">
                        ...
                        <a class="btn button bg-gray round" title="Incluir" href="<?php print( $form["pattern"]["new"] ) ?>"><i class="fontello-plus"></i> Novo Quiz</a>
                    </div>
                </form>
