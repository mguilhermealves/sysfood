        ...
        <form class="col-lg-12 mb-4" id="frm_filter" method="GET" action="<?php print($form["pattern"]["search"]) ?>">
            ...
            <div class="row">
                ...
                <div class="col-sm-10 col-lg-2">
                    ...
                    <button id="btn_export" type="submit" class="btn btn-primary btn-block btn-sm"><i
                            class="bi bi-file-excel"></i> Exportar</button>
                </div>
                ...
                <div class="col-sm-12 col-lg-2">
                    ...
                    <a id="btn_add" class="btn btn-primary btn-block btn-sm" title="Adicionar"
                        href="<?php print($form["pattern"]["new"]) ?>"><i class="bi bi-plus-circle"></i> Novo
                        Usuário</a>
                </div>
            </div>
                ...
                <thead class="thead-inverse">
                    <tr>
                        <th><a style="color:#707070; text-decoration:none"
                                href="<?php print(set_url($form["pattern"]["search"], array("ordenation" => $ordenation_idx))) ?>">ID
                                <i class="<?php print($ordenation_idx_ordenation) ?>"></i></a></th>
                        <th><a style="color:#707070; text-decoration:none"
                        ...
                        <th><a style="color:#707070; text-decoration:none"
                                href="<?php print(set_url($form["pattern"]["search"], array("ordenation" => $ordenation_cpf))) ?>">CPF
                                <i class="<?php print($ordenation_cpf_ordenation) ?>"></i></a></th>
                        <th><a style="color:#707070; text-decoration:none"
                                href="<?php print(set_url($form["pattern"]["search"], array("ordenation" => $ordenation_mail))) ?>">E-mail
                                <i class="<?php print($ordenation_mail_ordenation) ?>"></i></a></th>
                        <th><a style="color:#707070; text-decoration:none"
                                href="<?php print(set_url($form["pattern"]["search"], array("ordenation" => $ordenation_profiles))) ?>">Perfil
                                <i class="<?php print($ordenation_profiles_ordenation) ?>"></i></a></th>
                        <th>Ações</th>
                    </tr>
                </thead>
                <tfoot>
                                ...
                                <div class="col-lg-3 form-group">
                                    <select class="form-control" id="select_paginage" class="col-lg-3 ">
                                        ...
                                        <option <?php print($paginate == 50 ? 'selected="selected"' : '') ?> value="50">
                                            50</option>
                                        <option <?php print($paginate == 100 ? 'selected="selected"' : '') ?>
